                    ...
                    <form method="POST" action="{{ route('employees.update', $employee->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            @if ($employee->user_picture)
                                <img src="{{ Storage::url($employee->user_picture) }}" alt="{{ $employee->name }}" class="mt-2" width="200" height="200">
                            @endif
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-gray-500">{{ __('Leave blank to keep current password') }}</p>
                        </div>
