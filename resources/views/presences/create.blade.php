                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('presences.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="check_in" class="block mt-1 w-full" type="datetime-local" name="check_in" :value="old('check_in')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="check_out" class="block mt-1 w-full" type="datetime-local" name="check_out" :value="old('check_out')" required />
